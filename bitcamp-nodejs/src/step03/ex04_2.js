...
//[실행 URL]
// => http://localhost:8000/member/update?id=user01&email=user01@test.com&password=1111
// [출력 결과]
// 등록 성공입니다.
...
const server = http.createServer((req, res)=>{
    ...
    var password = parseInt(urlInfo.query.password);    
    
    // insert into pms2_member (mid, email, password) values(?, ?, ?), [id, email, password],
