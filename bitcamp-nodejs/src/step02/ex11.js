...
pool.getConnection(function(err, con) {
    ...
    con.query('select * from pms2_member', function(err, results) {
        ...
        con.release(); // 커넥션 풀에 연결객체를 반납한다.
        
        // 프로그램을 종료하고 싶다면 작업이 끝난후 커넥션 풀의 모든 커넥션을 닫아야 한다.
        // 보통 서버로서 실행하다가 종료 할 때 커넥션 풀을 닫는다.
